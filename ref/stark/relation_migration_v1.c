...
extern int spx_p2_rust_validate_strict_relation_inputs_v1(const spx_p2_ffi_public_inputs_v1 *pub,
                                                          const spx_p2_ffi_private_witness_v1 *wit,
                                                          int require_witness);
extern int spx_p2_rust_validate_strict_witness_relation_v1(const spx_p2_ffi_public_inputs_v1 *pub,
                                                           const spx_p2_ffi_private_witness_v1 *wit);
...
#ifndef SPX_P2_USE_RUST_STARK
static int spx_p2_relation_validate_sigma_c_m19_local_v1(const spx_p2_ffi_public_inputs_v1 *pub,
                                                         const spx_p2_ffi_private_witness_v1 *wit)
{
    ...
    {
        if (spx_p2_build_sigma_c_m20_pke(expected_sigma_c, &expected_sigma_c_len,
    ...
    else if (spx_p2_build_sigma_c_m19(expected_sigma_c, &expected_sigma_c_len,
                                      pub->com, wit->sigma_com,
                                      pub->pk_e, pub->pk_e_len,
                                      wit->omega2, wit->omega2_len) != 0)
    {
                                                     ...
                                                     const spx_p2_ffi_private_witness_v1 *wit)
{
    ...
    {
        int ret = spx_p2_relation_validate_sigma_c_m19_local_v1(pub, wit);
