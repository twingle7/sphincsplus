...
/*
 * Dev parameter set for full-AIR development.
 * No security claims — used for fast iteration during AIR implementation.
 * Target: ~131K trace rows, 5-15 min proving time with Winterfell.
 *
 * n=16  h=40  d=4  k=8  a=6  w=16
 */

/* Hash output length in bytes. */
#define SPX_N 16
/* Height of the hypertree. */
#define SPX_FULL_HEIGHT 40
