...
/*
 * Benchmark parameter set for full-AIR comparison.
 * Candidate 9 from parameter search: n=16, h=60, d=6, k=14, a=10, w=16
 * Claimed 128-bit security at q=65536.
 *
 * Expected full-AIR: ~524K trace rows, ~10,000 Poseidon2 perms
 */
